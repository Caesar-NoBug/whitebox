...
public class CommentServiceImpl implements CommentService {
    ...
    public void addComment(long userId, AddCommentRequest request) {
        long id = cacheRepo.nextId(RedisPrefix.COMMENT_INC_ID);
    ...
    private CommentVO loadCommentVO(Comment comment, UserMinVO publisher) {
        ...
        CommentVO commentVO = cacheRepo.getObject(
                RedisPrefix.CACHE_COMMENT + comment.getId());
        ...
        commentVO.setLikeNum(cacheRepo.getLongValue(
                RedisPrefix.COMMENT_LIKE_COUNT + comment.getId()));
