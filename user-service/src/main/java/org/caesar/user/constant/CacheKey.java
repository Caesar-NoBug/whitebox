...
public class CacheKey {
    ...
    public static final String AUTH_REFRESH_TOKEN = "login:refreshToken";
    public static final String AUTH_CODE_PHONE = "auth:phone:code:";
    ...
    public static final String AUTH_TIME = "auth:warn:%s:%s";
}
