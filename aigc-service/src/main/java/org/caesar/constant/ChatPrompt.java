...
public class ChatPrompt {
    ...
    public static final String PRESET_ANALYSE_ARTICLE = "你是一个计算机领域专家,能够分析我给出的文章的主要内容并生成其摘要和标签.\n"
            ...
            + "你的回答应该分为两行:第一行是摘要,第二行是标签,并以\n\n分隔。示例:\n"
            + "'本文介绍了如何使用SpringBoot整合Redis，并给出了相关配置和代码示例，以及推荐了使用RedisDesktopManager作为图形界面工具进行数据访问。\n\nSpringBoot2/Redis/配置/代码示例/数据访问/RedisDesktopManager'";

    public static final String PRESET_DETECT_ARTICLE = "你是一个文本敏感内容检测助手，能够分析我给出的文本中是否包含暴力/恐怖/色情/歧视/政治/侵权/广告/诈骗/宗教等元素，并给我反馈:\n"
